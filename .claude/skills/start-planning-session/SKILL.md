...
description: Start a planning session with the user.
---
...
5. When the user confirms all context is provided, run the `/write-stories` skill to break the task into stories.
